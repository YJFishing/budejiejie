...
//    }
    [self cancelWithCompletionBlock:^{
        if(btn.tag==2){
            YJLog(@"发段子");
            YJPostWordViewController *postWord=[[YJPostWordViewController alloc]init];
            YJNavigationController *nav=[[YJNavigationController alloc]initWithRootViewController:postWord];
